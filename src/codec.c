...
/*
 * Sets up the codec control by sending a very specific set of data
 */
...
/*
 * This sends some control data (ControlBytes) to the codec.
 * First sends start condition, sends the address to send to,
 * sends the data, then sends stop condition.
 * Only used in this function to set up the codec
 */
...
/*
 * This receives some data from the codec. Sends the address(mapbyte),
 * and then waits to receive from the codec
 * Only used in this function to set up the codec
 */
